...
Official objective summary, straight from CompTIA. Use this as the scope reference — if it's not covered here, it's not on the exam.

[[Home|← Home]]  |  [[01 - Contents|Contents →]]

---

## [[1.0 - General Security Concepts|General security concepts (12%)]]
...
## [[2.0 - Threats, Vulnerabilities, and Mitigations|Threats, vulnerabilities, and mitigations (22%)]]
...
## [[3.0 - Security Architecture|Security architecture (18%)]]
...
## [[4.0 - Operations and Incident Response|Security operations (28%)]]
...
## [[5.0 - Governance, Risk, and Compliance|Security program management and oversight (20%)]]
